...
//		out: &GoldapMessage{
//			MessageId: int(0x01),
//			BindRequest: GoldapBindRequest{
//				Version: int(0x03),
//				Login:   []byte(""),
//				Authentication: GoldapSaslCredentials{
//					Mechanism: []byte("CRAM-MD5"),
//				},
//			},
//		},
...
//
//	{
//		in: []byte{0x30, 0x29, 0x02, 0x01, 0x05, 0x60, 0x24, 0x02, 0x01, 0x03, 0x04, 0x07, 0x6d, 0x79, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x80, 0x0a, 0x6d, 0x79, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0xa3, 0x0a, 0x04, 0x08, 0x43, 0x52, 0x41, 0x4d, 0x2d, 0x4d, 0x44, 0x35},
//		out: &GoldapMessage{
//			MessageId: int(0x05),
//			BindRequest: GoldapBindRequest{
//				Version:  int(0x03),
...
//}
//
//var readgoldapmessageTestData = []struct {
//	in  []byte
//	out interface{}
//}{
//	{
...
//}
//
//func TestReadGoldapMessage(t *testing.T) {
//	for i, test := range readgoldapmessageTestData {
//		message, rest, err := ReadGoldapMessage(test.in)
//		if len(rest) > 0 {
//			t.Errorf("Rest bytes %v", rest)
//		}
//		if err != nil {
