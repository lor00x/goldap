...
type LDAPMessageTestSessionData struct {
	bytes Bytes
	out   LDAPMessage
}

func getLDAPMessageTestSessionData() (ret []LDAPMessageTestSessionData) {
	return []LDAPMessageTestSessionData{
		...
		// Request 117: CLIENT SearchRequest with controls
		{
			bytes: Bytes{
				offset: NewInt(0),
				bytes: []byte{
		...
		// Request 118: SERVER SearchResultDone with Controls
		{
			bytes: Bytes{
				offset: NewInt(0),
				bytes: []byte{
		...
		// Request 229: CLIENT SearchRequest with FilterGreaterOrEqual and FilterLessOrEqual
		{
			bytes: Bytes{
				offset: NewInt(0),
				bytes: []byte{
		...
		// Request 0: CLIENT SearchRequest with FilterExtensibleMatch
		{
			bytes: Bytes{
				offset: NewInt(0),
				bytes: []byte{
...
func TestReadLDAPMessageSession(t *testing.T) {
	for i, test := range getLDAPMessageTestSessionData() {
